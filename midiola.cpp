...
void parseCommandLine(int argc, char* argv[]) {
    option longopts[] = {{"mode", optional_argument, NULL, 'm'},    {"universe", optional_argument, NULL, 'u'}, {"cc", optional_argument, NULL, 'c'},
                         {"note", optional_argument, NULL, 'n'},    {"verbose", optional_argument, NULL, 'V'},  {"version", optional_argument, NULL, 'v'},
                         {"exclude", optional_argument, NULL, 'x'}, {"help", optional_argument, NULL, 'h'},     {NULL, 0, 0, 0}};
    while (1) {
...
int main(int argc, char* argv[]) {
    ...
    if ((g_jackClient = jack_client_open("jackmidiola", JackNoStartServer, &jackStatus, serverName)) == 0) {
